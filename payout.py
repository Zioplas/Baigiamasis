...
class Payout:
    ...
    def check_for_payout(self, bet, symbols):
        if symbols[0] == symbols[1] == symbols[2]:
            ...
            return round(bet * (self.payouts.get(symbols[0]) / 6), 2)

        elif symbols[1] == symbols[2]:
            return round(bet * (self.payouts.get(symbols[1]) / 6), 2)
